...
async function generateRecommendation(payload) {
    const response = await client.responses.create({
        ...
        instructions: [
            ...
            'If correct, write 1 to 2 short sentences that begin with encouragement and then add one compact trivia or usage detail about the correct word or phrase.',
            'For correct answers, keep the full message short enough to fit comfortably in a small mobile feedback card.',
            'For correct answers, prefer details such as common use, context, category, literal sense, rhythm, or a memorable fact about the answer.',
            'For correct answers, do not sound like a dictionary entry or a lecture.',
            'For correct answers, avoid generic praise by itself. Always include one useful detail after the encouragement.',
            ...
            'Keep every response concise, screen-friendly, and easy to read at a glance.',
